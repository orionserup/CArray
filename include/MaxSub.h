...
#define MAXSUB_BRUTE (ArrayFunction) { .function.subfun = (ArraySubFun){ MaxSubArrayBrute, "MaxSubArrayBrute"}, .functiontype = SUB }  // a global definition for benchmarking
...
#define MAXSUB_REC (ArrayFunction){ .function.subfun = (ArraySubFun){ MaxSubArrayRec, "MaxSubArrayRec" }, .functiontype = SUB }  // a global definition for benchmarking
/// C Array Wrapper
#define MaxSubArrRec(arr, size, subarrsize) MaxSubArrRec((Array){arr, size})
